        ...
        <table className="w-full text-sm text-slate-700 dark:text-gray-300">
          <thead>
            <tr className="border-b-2 border-slate-300 bg-white dark:bg-gray-800">
              <th
                scope="col"
                className="w-12 px-2 py-2 text-left font-semibold whitespace-nowrap"
              >
                ID#
              </th>
              <th
                scope="col"
                className="px-2 pr-4 py-2 text-left font-semibold whitespace-nowrap"
              >
                Incident Title
              </th>
              <th
                scope="col"
                className="hidden md:table-cell w-24 px-2 py-2 text-left font-semibold whitespace-nowrap"
              >
                Start Date
              </th>
              <th
                scope="col"
                className="w-24 px-2 py-2 text-left font-semibold"
              >
                Status
              </th>
              <th
                scope="col"
                className="hidden xl:table-cell w-28 px-2 py-2 text-left font-semibold whitespace-nowrap"
              >
                Alerts Report
              </th>
              <th
                scope="col"
                className="hidden lg:table-cell w-40 px-2 py-2 text-left font-semibold whitespace-nowrap"
              >
                ASNs Impacted
              </th>
              <th
          ...
          <tbody>
            {isLoading && (!data || data.length === 0) && (
              <tr>
                <td
                  colSpan={9}
                  className="px-4 py-12 text-center text-slate-500 dark:text-gray-400"
                >
                  Loading data...
                </td>
              </tr>
              ...
              return (
                <Fragment key={inc._id}>
                  <tr className="border-b border-slate-200 dark:border-gray-700 hover:bg-slate-50 dark:hover:bg-gray-700/40 transition-colors">
                    ...
                    <td className="hidden md:table-cell px-2 py-2 whitespace-nowrap text-[18px]">
                      <div>{date}</div>
                      {time && (
                        <div className="text-[18px] text-slate-500 dark:text-gray-400 mt-0.5">
                          {time}
                    ...
                    <td
                      className={`px-2 py-2 whitespace-nowrap ${statusClass[status]}`}
                    >
                      {status}
                    </td>
                    ...
                    <td className="px-2 py-2 whitespace-nowrap">
                      <button
                        type="button"
                        onClick={() =>
                          setExpandedRow(isExpanded ? null : inc._id)
                        }
