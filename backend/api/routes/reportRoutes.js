...
router.put('/:_id', User.can('edit data'), reportController.requireReportAccess, reportController.report_update);

// Update reports veracity
router.patch('/_veracity', User.can('edit data'), reportController.requireReportAccess, reportController.reports_veracity_update);

// Update reports read
router.patch('/_read', User.can('edit data'), reportController.requireReportAccess, reportController.reports_read_update);

// Update reports escalation
router.patch('/_escalated', User.can('edit data'), reportController.requireReportAccess, reportController.reports_escalated_update);
...
// Add tag to reports
router.patch('/_tag', User.can('edit data'), reportController.requireReportAccess, reportController.reports_tags_add);

// Remove tag from reports
router.patch('/_untag', User.can('edit data'), reportController.requireReportAccess, reportController.reports_tags_remove);

// Update tags from reports
router.patch('/_tags', User.can('edit data'), reportController.requireReportAccess, reportController.reports_tags_update);

// Clear tags from reports
router.patch('/_clearTags', User.can('edit data'), reportController.requireReportAccess, reportController.reports_tags_clear);
